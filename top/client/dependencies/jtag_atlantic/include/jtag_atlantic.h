/* This header file provides a description of the functions and parameters
 * used in the jtag_atlantic.dll and jtag_client.dll libraries.
 *
 * Credit: thotypous
 * Source: https://github.com/tomverbeure/alterajtaguart/tree/master/software
 */
